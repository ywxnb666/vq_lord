...
STAGE3_SAMPLE_CACHE_PATH="${STAGE3_SAMPLE_CACHE_PATH:-${DATA_DIR}/stage3/stage3_sample_cache_${STAGE3_SAMPLE_CACHE_DATASET_PREFIX}${STAGE3_SAMPLE_CACHE_MODEL_PREFIX}${VICTIM_MODEL}_${DATASET_SPLIT}_n${TRAIN_NUM}_seed${DATASET_SEED}_ml${MAX_LENGTH}_ctx${STAGE3_VIC_INCLUDE_CONTEXT}_obs${TEACHER_OBSERVED_MAX_TOKENS}_txt${TEACHER_CONTEXT_MAX_TOKENS}_rsn${TEACHER_REASONING_MAX_TOKENS}_ans${TEACHER_ANSWER_MAX_TOKENS}.pt}"
...
STAGE3_VALIDATION_RESULT_PATH="${STAGE3_VALIDATION_RESULT_PATH:-${TEST_RESULT_DIR}/stage3_validation_generate_readable.json}"
STAGE3_TEST_RESULT_PATH="${STAGE3_TEST_RESULT_PATH:-${TEST_RESULT_DIR}/stage3_test_generate_readable.json}"
