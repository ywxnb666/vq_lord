...
# STAGE3_MC_WEIGHT="${STAGE3_MC_WEIGHT:-0.00}"
# STAGE3_OBJ_WEIGHT="${STAGE3_OBJ_WEIGHT:-0.10}"
# STAGE3_REG_WEIGHT="${STAGE3_REG_WEIGHT:-0.20}"
# STAGE3_READABLE_SFT_WEIGHT="${STAGE3_READABLE_SFT_WEIGHT:-0.5}"
# STAGE3_ANSWER_ANCHOR_WEIGHT="${STAGE3_ANSWER_ANCHOR_WEIGHT:-0.8}"
# STAGE3_ANSWER_PREFIX_WEIGHT="${STAGE3_ANSWER_PREFIX_WEIGHT:-1}"
