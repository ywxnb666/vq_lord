...
EVAL_ANSWER_MODE=generate     # logits, generate, hybrid
USE_4BIT=0
USE_VQ=1
...
STAGE2_FINAL_ADAPTER_PATH="${STAGE2_FINAL_ADAPTER_PATH:-${CKPT_DIR}/stage2/stage2_sub1_period8}"
# STAGE2_FINAL_ADAPTER_PATH="/inspire/hdd/project/robot-reasoning/xiangyushun-p-xiangyushun/luye/align_vq/align/vq_lord_ckpts_stage2_tune/run_20260323_140152/stage2_sub1_period7"
