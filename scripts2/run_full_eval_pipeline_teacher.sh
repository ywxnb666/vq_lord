...
echo "[Launcher] Stage 0: special benchmarks"
"${PYTHON_BIN}" -u /root/workspace/vq_lord/vq_lord3/evaluation/final/mm_special_benchmark_eval_teacher.py \
...
echo "[Launcher] Stage 1: ScienceQA controls"
"${PYTHON_BIN}" -u /root/workspace/vq_lord/vq_lord3/evaluation/final/mm_scienceqa_control_eval_teacher.py \
...
echo "[Launcher] Stage 2: report aggregation"
