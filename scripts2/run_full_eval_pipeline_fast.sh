...
ADAPTER_PATH="${ADAPTER_PATH:-/root/workspace/vq_lord/vq_lord_ckpts/stage2_sub1_period7}"
SCIENCEQA_PATH="${SCIENCEQA_PATH:-/root/autodl-tmp/datasets/ScienceQA}"
VQ_CODEBOOK_PATH="${VQ_CODEBOOK_PATH:-/root/workspace/vq_lord/vq_lord_ckpts/stage2_sub1_period7/vq_codebook.pt}"
...
printf '[Launcher] Stage 0: special benchmarks\n'
"${PYTHON_BIN}" -u /root/workspace/vq_lord/vq_lord3/evaluation/final/mm_special_benchmark_eval_fast.py \
...
printf '[Launcher] Stage 1: scienceqa controls\n'
"${PYTHON_BIN}" -u /root/workspace/vq_lord/vq_lord3/evaluation/final/mm_scienceqa_control_eval_fast.py \
  --model_path "${MODEL_PATH}" \
  --adapter_path "${ADAPTER_PATH}" \
  --use_vq 1 \
  --vq_codebook_size 1024 \
...
printf '[Launcher] Stage 2: report aggregation\n'
"${PYTHON_BIN}" -u /root/workspace/vq_lord/vq_lord3/evaluation/final/mm_eval_suite_report.py \
