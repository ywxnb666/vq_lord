...
# STAGE2_RESUME_PATH="${STAGE2_RESUME_PATH:-${CKPT_DIR}/stage2_resume_latest}"
STAGE2_RESUME_SAVE_PATH="${STAGE2_RESUME_SAVE_PATH:-${CKPT_DIR}/stage2/stage2_resume_latest}"
...
STAGE2_FIELD_WEIGHT_REASONING="${STAGE2_FIELD_WEIGHT_REASONING:-0.5}"
STAGE2_FIELD_WEIGHT_ANSWER="${STAGE2_FIELD_WEIGHT_ANSWER:-6.0}"
STAGE2_ANSWER_PREFIX_WEIGHT="${STAGE2_ANSWER_PREFIX_WEIGHT:-12.0}"
...
echo "STAGE2_FIELD_WEIGHTS: observed=${STAGE2_FIELD_WEIGHT_OBSERVED}, context=${STAGE2_FIELD_WEIGHT_CONTEXT}, reasoning=${STAGE2_FIELD_WEIGHT_REASONING}, answer=${STAGE2_FIELD_WEIGHT_ANSWER}, answer_prefix=${STAGE2_ANSWER_PREFIX_WEIGHT}"
