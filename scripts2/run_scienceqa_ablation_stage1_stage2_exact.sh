...
STAGE1_ADAPTER="${STAGE1_ADAPTER:-/root/workspace/vq_lord/vq_lord_ckpts/stage1_vision_epoch15}"
STAGE2_ADAPTER="${STAGE2_ADAPTER:-/root/workspace/vq_lord/vq_lord_ckpts/stage2_sub1_period7}"
STAGE1_VQ="${STAGE1_VQ:-/root/workspace/vq_lord/vq_lord_ckpts/stage1_vision_epoch15/vq_codebook.pt}"
STAGE2_VQ="${STAGE2_VQ:-/root/workspace/vq_lord/vq_lord_ckpts/stage2_sub1_period7/vq_codebook.pt}"
...
"${PYTHON_BIN}" /root/workspace/vq_lord/vq_lord3/evaluation/final/mm_scienceqa_control_eval_fast.py \
  ...
  --vq_codebook_path "${STAGE1_VQ}" \
  --save_path "${RESULT_DIR}/scienceqa_ablation_stage1_exact.json" \
  > "${LOG_DIR}/scienceqa_ablation_stage1_exact.log" 2>&1
