...
"${PYTHON_BIN}" "${TRAIN_ENTRY}" \
    ...
    --stage2_rationale_weight="0.3" \
    --stage2_prepost_lr_scale="0.5" \
...
echo "Stage1 产物: ${STAGE1_CODEBOOK_PATH}"
