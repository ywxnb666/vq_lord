...
MODEL_DEFAULT="/mnt/shared-storage-gpfs2/evoagi-share-gpfs2/xhsong/models/llava-v1.6-mistral-7b-hf"
...
TRAIN_NUM_DEFAULT_SCIENCEQA="6190"
...
# VICTIM_MODEL_DEFAULT_SCIENCEQA="qwen3.5-flash-2026-02-23"
VICTIM_MODEL_DEFAULT_SCIENCEQA="gemini2.5-pro"
