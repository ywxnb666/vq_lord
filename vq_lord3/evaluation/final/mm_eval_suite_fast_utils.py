...
from vq_lord3.evaluation.sciqa_process import (
    build_prompt as build_simple_scienceqa_prompt,
    extract_choice_from_output as extract_choice_from_stage1_output,
    predict_choice_with_next_token_logits as predict_stage1_choice_with_next_token_logits,
)
...
from vq_lord3.evaluation.sciqa_process2_parallel import predict_choices_with_next_token_logits_batch
...
def _build_mcq_prompt(processor, sample: StandardSample, prompt_style: str) -> str:
    # Keep ScienceQA prompts identical to the original stage1/stage2 eval scripts
...
def run_scienceqa_mcq_samples_exact(
    ...
    if prompt_style == "simple":
        extract_choice_fn = extract_choice_from_stage1_output
        predict_choice_fn = predict_stage1_choice_with_next_token_logits
    else:
