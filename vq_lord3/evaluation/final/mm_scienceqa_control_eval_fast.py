from vq_lord3.evaluation.final import _eval_final_bootstrap  # noqa: F401
...
from vq_lord3.evaluation.final.mm_eval_suite_fast_utils import run_scienceqa_mcq_samples_exact
from vq_lord3.evaluation.final.mm_eval_suite_utils import (
    StandardSample,
...
from vq_lord3.evaluation.final.mm_scienceqa_control_eval import CONTROL_ORDER, build_control_variant
from vq_lord3.evaluation.sciqa_process import load_model_and_processor as load_stage1_model_and_processor
from vq_lord3.evaluation.sciqa_process2 import load_model_and_processor as load_stage2_model_and_processor
...
def load_original_scienceqa_model(args):
    if args.prompt_style == "simple":
        loader = load_stage1_model_and_processor
...
def parse_args():
    parser = argparse.ArgumentParser(description="Run ScienceQA control experiments with the exact original stage1/stage2 evaluation path.")
    ...
    parser.add_argument("--use_4bit", type=int, default=0, help="Whether to use 4bit loading; original stage1/stage2 test scripts use 0")
