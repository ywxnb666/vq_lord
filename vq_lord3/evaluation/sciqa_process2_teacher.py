...
ScienceQA 教师模型验证脚本（旧 Stage2 prompt 口径）
...
from vq_lord3.data.data_collector import GPT4VDataCollector, _parse_optional_bool
...
def parse_args():
    parser = argparse.ArgumentParser(description="ScienceQA 教师模型验证脚本（旧 Stage2 prompt 口径）")
...
def main():
    ...
    run_config = {
        ...
        "prompt_style": "stage2_legacy_teacher",
