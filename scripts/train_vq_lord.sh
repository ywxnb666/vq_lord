...
export stage=1                  # 训练阶段 (1=VQ预训练, 2=视觉蒸馏, 3=全部)
...
# 兜底参数（防止空字符串传参导致 argparse 报错）
export stage2_grad_accum="${stage2_grad_accum:-0}"
export stage3_grad_accum="${stage3_grad_accum:-0}"
